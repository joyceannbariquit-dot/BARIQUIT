...
public class myprofile extends javax.swing.JFrame {
   ...
   try {
    ...
    private void initComponents() {
        ...
        Fullname.setBackground(new java.awt.Color(153, 204, 255));
        ...
        Fullname.add(lblFullname, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, -1, -1));

        lblEmail.setFont(new java.awt.Font("Palatino Linotype", 0, 14)); // NOI18N
        lblEmail.setText("Email:");
        Fullname.add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, -1, -1));

        lblRole.setFont(new java.awt.Font("Palatino Linotype", 0, 14)); // NOI18N
        lblRole.setText("Role:");
        Fullname.add(lblRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 260, 130, -1));
        ...
        Fullname.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 50, 150, 110));

        jPanel1.add(Fullname, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 800, 400));
