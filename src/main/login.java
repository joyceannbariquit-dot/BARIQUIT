...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon("C:\\Users\\reyma\\Documents\\HOY\\studentinfo\\system\\src\\image\\lgo.jfif")); // NOI18N
  ...
  String email = txtEmail.getText().trim();
    ...
    // Gigamit nato ang con.hashPassword tungod kay naa sa config class ang method
    String hashedPassword = config.config.hashPass(password); 

    // 3. AUTHENTICATE USING HASHED PASSWORD
    if (con.authenticate(email, hashedPassword)) {
        try {
